...
try {
    ...
    header('Location: listar-pacientes.php?sucesso=paciente-removido');
    exit;
} 
    ...
    if ($codigoBanco->getCode() == '23503') {
        header('Location: listar-pacientes.php?erro=vinculo-existente');
        exit;
    }
    
    header('Location: listar-pacientes.php?erro=impossivel-remover');
    exit;
